...
from gym_fishing.envs.forage_VVH_v3_env import forageVVH_v3
from gym_fishing.envs.forage_VVH_v4_env import forageVVHv4
...
register(
    id="threeFishing-v3",
    entry_point="gym_fishing.envs:forageVVH_v3",
)

register(
    id="threeFishing-v4",
    entry_point="gym_fishing.envs:forageVVHv4",
)
